$(function () {
  ...
  var emojies = [
    ...
    'bowtie', 'boy', 'bread', 'bride_with_veil', 'bridge_at_night',
    ...
    'fr', 'free', 'fried_shrimp', 'fries', 'frog', 'frowning', 'fu',
    'fuelpump', 'full_moon', 'full_moon_with_face', 'game_die', 'gb', 'gem',
    'gemini', 'ghost', 'gift', 'gift_heart', 'girl', 'globe_with_meridians',
    'goat', 'goberserk', 'godmode', 'golf', 'grapes', 'green_apple',
    'green_book', 'green_heart', 'grey_exclamation', 'grey_question',
    ...
    'lipstick', 'lock', 'lock_with_ink_pen', 'lollipop', 'loop', 'loudspeaker',
    ...
    'rage', 'rage1', 'rage2', 'rage3', 'rage4', 'railway_car', 'rainbow',
    'raised_hand', 'raised_hands', 'raising_hand', 'ram', 'ramen', 'rat',
    'recycle', 'red_car', 'red_circle', 'registered', 'relaxed', 'relieved',
    'repeat', 'repeat_one', 'restroom', 'revolving_hearts', 'rewind', 'ribbon',
    ...
    'seat', 'secret', 'see_no_evil', 'seedling', 'seven', 'shaved_ice',
